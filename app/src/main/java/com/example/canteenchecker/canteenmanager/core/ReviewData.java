...
public class ReviewData {
    ...
    public ReviewData(float averageRating, int totalRatings,
                      int ratingsOne, int ratingsTwo, int ratingsThree,
                      int ratingsFour, int ratingsFive) {
        ...
        totalRatingsOfMostCommonGrade =
                Math.max(Math.max(Math.max(Math.max(ratingsOne, ratingsTwo),
                        ratingsThree), ratingsFour), ratingsFive);
    }
